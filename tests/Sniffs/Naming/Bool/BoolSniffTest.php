...
namespace DTForce\CodingStandard\Tests\Sniffs\Naming\Bool;
...
/**
 * @covers DTForceCodingStandard\Sniffs\Naming\BoolSniff
 */
final class BoolSniffTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$codeSnifferRunner = new CodeSnifferRunner('DTForceCodingStandard.Naming.Bool');
